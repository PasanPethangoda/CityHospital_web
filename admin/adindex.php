        ...
        <div class="col-md-12">
            <div class="row">
                ...
                ?>
                    ...
                    <div class="col-md-10 ">
                        <h4 class="my-4 text-center" style="color:green;"><b>ADMIN DASHBOARD</b></h4>
                            ...
                            <div class="col-md-3 bg-warning mx-2" style="height: 130px;"> 
                                      <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <a href="admins.php"><i class="fa  fa-users-cog fa-3x my-4" style="color:white;"></i></a>
                            ...
                            <div class="col-md-3 bg-info mx-2" style="height: 130px;">
                                  <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-8">
                                            <?php 
                                            $doctor = mysqli_query($connect,"SELECT * FROM doctors");
