...
<div class="container-fluid">
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="col-md-10">
                <h3 class="text-center" style="color:green; margin-top:30px;">EDIT DOCTORS SALARY </h3>
                ...
                ?>
                 <div class="row">
                    <div class="col-md-8">
                        <h5 class="text-left" style="color:blue;">DOCTOR DETAILS</h5>
